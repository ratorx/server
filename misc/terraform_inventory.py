...
Slightly modified from original to fix for Python 3.9 with remote terraform workspaces.
Original terraform script from https://github.com/nbering/terraform-inventory
License for this script: https://github.com/nbering/terraform-inventory/blob/master/LICENSE
'''
